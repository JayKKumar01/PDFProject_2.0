 ...
 */
public class PDFWordExtractor6 extends PDFTextStripper {
     ...
     */
    public PDFWordExtractor6(File file, List<Integer> pages) throws IOException {
    ...
    protected void writeString(String string, List<TextPosition> texts) {
        ...
        //System.out.println(string.length()+": "+texts.size()+": "+string);

        for (int i=0; i<texts.size();i++){
            TextPosition text = texts.get(i);
